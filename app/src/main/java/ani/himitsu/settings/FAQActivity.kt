...
import ani.himitsu.databinding.ActivityFaqBinding
...
class FAQActivity : AppCompatActivity() {
    ...
    private val faqs by lazy {
        listOf(
            ...
            Triple(
                R.drawable.round_smart_button_24,
            ...
            Triple(
                R.drawable.round_art_track_24,
                getString(R.string.question_14),
                getString(R.string.answer_14)
            ),
            Triple(
                R.drawable.round_video_settings_24,
