package ani.himitsu.connections.anilist.api
...
class Query {
    ...
    data class Viewer(
        ...
        data class Data(
            @SerialName("Viewer")
            val user: ani.himitsu.connections.anilist.api.User?
        )
    }
    ...
    data class Media(
        ...
        data class Data(
            @SerialName("Media")
            val media: ani.himitsu.connections.anilist.api.Media?,
            @SerialName("Page")
            val page: ani.himitsu.connections.anilist.api.Page?
        )
    }
...
//    ){
//        data class Data(
//            val AiringSchedule: ani.himitsu.connections.anilist.api.AiringSchedule?
//        )
//    }
    ...
    data class Character(
        ...
        data class Data(
            ...
            val character: ani.himitsu.connections.anilist.api.Character?
        )
    }
    ...
    data class Studio(
        ...
        data class Data(
            @SerialName("Studio")
            val studio: ani.himitsu.connections.anilist.api.Studio?
        )
    }
...
//    ){
//        data class Data(
//            val MediaList: ani.himitsu.connections.anilist.api.MediaList?
//        )
//    }
    ...
    data class MediaListCollection(
        ...
        data class Data(
            ...
            val mediaListCollection: ani.himitsu.connections.anilist.api.MediaListCollection?
        )
    }
    ...
    data class CombinedMediaListResponse(
        ...
        @Serializable
        data class Data(
            @SerialName("current") val current: ani.himitsu.connections.anilist.api.MediaListCollection?,
            @SerialName("planned") val planned: ani.himitsu.connections.anilist.api.MediaListCollection?,
            @SerialName("repeating") val repeating: ani.himitsu.connections.anilist.api.MediaListCollection?,
        )
    }
    ...
    data class HomePageMedia(
        ...
        @Serializable
        data class Data(
            @SerialName("currentAnime") val currentAnime: ani.himitsu.connections.anilist.api.MediaListCollection?,
            @SerialName("repeatingAnime") val repeatingAnime: ani.himitsu.connections.anilist.api.MediaListCollection?,
            @SerialName("favoriteAnime") val favoriteAnime: ani.himitsu.connections.anilist.api.User?,
            @SerialName("plannedAnime") val plannedAnime: ani.himitsu.connections.anilist.api.MediaListCollection?,
            @SerialName("currentManga") val currentManga: ani.himitsu.connections.anilist.api.MediaListCollection?,
            @SerialName("repeatingManga") val repeatingManga: ani.himitsu.connections.anilist.api.MediaListCollection?,
            @SerialName("favoriteManga") val favoriteManga: ani.himitsu.connections.anilist.api.User?,
            @SerialName("plannedManga") val plannedManga: ani.himitsu.connections.anilist.api.MediaListCollection?,
            @SerialName("recommendationQuery") val recommendationQuery: ani.himitsu.connections.anilist.api.Page?,
            @SerialName("recommendationPlannedQueryAnime") val recommendationPlannedQueryAnime: ani.himitsu.connections.anilist.api.MediaListCollection?,
            @SerialName("recommendationPlannedQueryManga") val recommendationPlannedQueryManga: ani.himitsu.connections.anilist.api.MediaListCollection?,
    ...
    data class AnimeList(
        ...
        @Serializable
        data class Data(
            @SerialName("recentUpdates") val recentUpdates: ani.himitsu.connections.anilist.api.Page?,
            @SerialName("recentUpdates2") val recentUpdates2: ani.himitsu.connections.anilist.api.Page?,
            @SerialName("trendingMovies") val trendingMovies: ani.himitsu.connections.anilist.api.Page?,
            @SerialName("trendingMovies2") val trendingMovies2: ani.himitsu.connections.anilist.api.Page?,
            @SerialName("topRated") val topRated: ani.himitsu.connections.anilist.api.Page?,
            @SerialName("topRated2") val topRated2: ani.himitsu.connections.anilist.api.Page?,
            @SerialName("mostFav") val mostFav: ani.himitsu.connections.anilist.api.Page?,
            @SerialName("mostFav2") val mostFav2: ani.himitsu.connections.anilist.api.Page?,
        )
    }
    ...
    data class MangaList(
        ...
        @Serializable
        data class Data(
            @SerialName("trendingManga") val trendingManga: ani.himitsu.connections.anilist.api.Page?,
            @SerialName("trendingManga2") val trendingManga2: ani.himitsu.connections.anilist.api.Page?,
            @SerialName("trendingManhwa") val trendingManhwa: ani.himitsu.connections.anilist.api.Page?,
            @SerialName("trendingManhwa2") val trendingManhwa2: ani.himitsu.connections.anilist.api.Page?,
            @SerialName("trendingNovel") val trendingNovel: ani.himitsu.connections.anilist.api.Page?,
            @SerialName("trendingNovel2") val trendingNovel2: ani.himitsu.connections.anilist.api.Page?,
            @SerialName("topRated") val topRated: ani.himitsu.connections.anilist.api.Page?,
            @SerialName("topRated2") val topRated2: ani.himitsu.connections.anilist.api.Page?,
            @SerialName("mostFav") val mostFav: ani.himitsu.connections.anilist.api.Page?,
            @SerialName("mostFav2") val mostFav2: ani.himitsu.connections.anilist.api.Page?,
    ...
    data class FollowerPage(
        ...
        val followers: List<ani.himitsu.connections.anilist.api.User>?
    ) : java.io.Serializable

    @Serializable
    data class FollowingPage(
        @SerialName("following")
        val following: List<ani.himitsu.connections.anilist.api.User>?
    ) : java.io.Serializable
    ...
    data class Review(
        ...
        val user: ani.himitsu.connections.anilist.api.User?,
        @SerialName("media")
        var media: ani.himitsu.connections.anilist.api.Media?,
    ) : java.io.Serializable
