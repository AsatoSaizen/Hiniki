...
enum class MediaStatus {
    ...
    override fun toString(): String {
        return when (super.toString()) {
            Status.FINISHED -> getString(R.string.status_finished)
            Status.RELEASING -> getString(R.string.status_releasing)
            Status.UNRELEASED -> getString(R.string.status_not_yet_released)
            Status.CANCELLED -> getString(R.string.status_cancelled)
            Status.HIATUS -> getString(R.string.status_hiatus)
