...
import ani.himitsu.databinding.ItemCommentsBinding
...
import ani.himitsu.util.ColorEditor.Companion.adjustColorForContrast
import ani.himitsu.util.ColorEditor.Companion.getContrastRatio
...
class CommentItem(
    ...
    override fun bind(viewBinding: ItemCommentsBinding, position: Int) {
        ...
        viewBinding.apply {
            ...
            if (comment.tag == null) {
                ...
                viewBinding.commentUserTag.text = comment.tag.string
            }
            ...
            commentUserName.setOnClickListener {
                commentsFragment.activity.startActivity(
            ...
            commentInfo.setOnClickListener {
                PopupMenu(commentsFragment.requireContext(), commentInfo).apply {
                    ...
                    menu.findItem(R.id.commentBanUser)?.isVisible = !isUserComment
            ...
            commentTotalVotes.text = (comment.upvotes - comment.downvotes).string
    ...
    private fun removeSubCommentIds() {
        subCommentIds.forEach { id ->
            ...
            parentComments.find { it.comment.commentId == id }?.let {
    ...
    private fun dialogBuilder(title: String, message: String, callback: () -> Unit) {
        val alertDialog =
            android.app.AlertDialog.Builder(commentsFragment.activity, R.style.MyDialog)
                .setTitle(title)
                .setMessage(message)
